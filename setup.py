...
setup(
    ...
    author="RS-GRPO Authors",
    author_email="",
    description="Reward-Separable GRPO for Video Reasoning",
    long_description=open("README.md", "r", encoding="utf-8").read(),
    long_description_content_type="text/markdown",
    keywords="video reasoning multimodal reinforcement learning grpo rs-grpo",
    license="Apache",
    url="https://github.com/just-a-go/RS-GRPO",
    package_dir={"": "src"},

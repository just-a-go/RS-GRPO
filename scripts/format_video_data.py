...
def main():
    ...
    parser.add_argument(
        "--video-root",
        default=os.environ.get("VIDEO_ROOT", "data/videos"),
        help="Root directory containing source videos.",
    )
    parser.add_argument(
        "--jsonl-file",
        default=os.environ.get("JSONL_FILE", "data/train.jsonl"),
        help="Input JSONL file.",
    )
    parser.add_argument(
        "--output-file",
        default=os.environ.get("OUTPUT_FILE", "data/LLaVA-Video-large-swift-origin.jsonl"),
